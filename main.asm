...
; Uses Timer2 in CTC (Clear Timer on Compare Match) Mode
; Calculation: 16MHz / (2 * 1 * 38000) - 1 = 210
;==========================================================================
CARRIER_INIT:
    ; 1. Set PB3 as an Output
    in    r16, DDRB
    ori   r16, (1<<3)               ; Set bit 3 high
    out   DDRB, r16

    ; 2. Set the frequency limit (TOP value) to 210
    ldi   r16, 210
    sts   OCR2A, r16

    ; 3. Configure Timer2: Toggle OC2A on match, CTC Mode
    ldi   r16, (1<<COM2A0) | (1<<WGM21)
    sts   TCCR2A, r16

    ; 4. Start Timer2 with No Prescaler (run at full 16MHz)
    ldi   r16, (1<<CS20)
    sts   TCCR2B, r16
    ret
